...
class EditProfileScreen extends StatelessWidget {
          ...
          children: [
            Consumer<ChannelNameProvider>(
              builder: (context, channelNameProvider, _) => Align(
                alignment: Alignment.topLeft, // Align the content to the upper-left corner
                child: Row(
                  children: [
                    CircleAvatar(
                    ...
                    SizedBox(width: 20), // Add spacing between the profile picture and the text
                    Text(
            ...
            Consumer<ChannelNameProvider>(
              builder: (context, channelNameProvider, _) => GestureDetector(
                onTap: () => _showChangePictureDialog(context, channelNameProvider),
                child: Padding(
                  padding: const EdgeInsets.all(8.0),
                  child: Container(
                    height: 100, // Set the desired height of the rectangular container
                    decoration: BoxDecoration(
                      ...
                      image: DecorationImage(
                        fit: BoxFit.cover,
                        image: NetworkImage(channelNameProvider.profilePictureUrl),
                      ),
                    ),
                    child: Center(
                      child: CircleAvatar(
  ...
  void _showRenameDialog(BuildContext context) {
    ...
    final channelNameProvider = Provider.of<ChannelNameProvider>(context, listen: false);
  ...
  void _showChangePictureDialog(BuildContext context, ChannelNameProvider channelNameProvider) {
    showDialog(
      context: context,
      builder: (BuildContext context) {
        return AlertDialog(
