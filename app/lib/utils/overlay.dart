...
class QrScannerOverlayShape1 extends ShapeBorder {
  QrScannerOverlayShape1({
    this.borderColor = Colors.red,
    this.borderWidth = 4.0,
    this.overlayColor = const Color.fromARGB(255, 238, 238, 238),
    this.borderRadius = 0,
  ...
  })  : cutOutWidth = cutOutWidth ?? cutOutSize ?? 350,
        cutOutHeight = cutOutHeight ?? cutOutSize ?? 350 {
    assert(
    borderLength <=
